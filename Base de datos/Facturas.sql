...
AS
BEGIN
    INSERT INTO FACTURAS (FAC_CED_CLIENTE, FAC_COD_PRODUCTO, FAC_ID_COLABORADOR, FECHA, TOTAL_PAGADO)
    VALUES (P_FAC_CED_CLIENTE, P_FAC_COD_PRODUCTO, P_FAC_ID_COLABORADOR, P_FECHA, P_TOTAL_PAGADO);
    COMMIT;
